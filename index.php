      ...
      <div class="row">
        <div class="col-md-12">
          <div class="mu-gallery-area">
            ...
            <div class="mu-title">
              <span class="mu-subtitle">Walk Through</span>
              <h2>Our Gallery</h2>
            </div>
          ...
          <div class="col-md-12">
            <div class="mu-client-testimonial-area">
              ...
              <div class="mu-title">
                ...
                <h2>What Our Beloved Customers Have To Say</h2>
              </div>
                  ...
                  <li>
                    <div class="mu-testimonial-single">                   
                      <div class="mu-testimonial-info">
                        <p>This was such a splendid treat. Loved the food and the standards here are abosuletly fantastic</p>
                      </div>
                   ...
                   <li>
                    <div class="mu-testimonial-single">                   
                      <div class="mu-testimonial-info">
                        <p>This is the best food i've ever had. I would definitely recommend it.</p>
                      </div>
                      <div class="mu-testimonial-bio">
                        <p>- Trevor James</p>                      
                      </div>
                   ...
                   <li>
                    <div class="mu-testimonial-single">                   
                      <div class="mu-testimonial-info">
                        <p>I am so glad I came here. The food did not dissapoint.</p>
                      </div>
                      <div class="mu-testimonial-bio">
                        <p>- Steve Jobs</p>                      
                      </div>
              ...
              <ul class="mu-chef-nav">
                ...
                <li>
                  <div class="mu-single-chef">
                    ...
                    <div class="mu-single-chef-info">
                      <h4>Claudio Aprile</h4>
                      <span>Italian Chef</span>
                    </div>
                    <div class="mu-single-chef-social">
                      <a href="#"><i class="fa fa-facebook"></i></a>
                      <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <li>
                  <div class="mu-single-chef">
                    <figure class="mu-single-chef-img">
                      <img src="assets/img/chef/chef-8.jpg" alt="chef img">
                    </figure>
                    <div class="mu-single-chef-info">
